 ...
 * {@link MessageStructurePool}의 인메모리 캐시를 초기화한다.</p>
 *
 * <p>spider-link AutoConfiguration으로 자동 등록된다.
 * {@link MessageStructurePool} 빈이 없으면(고정길이 전문 미사용) 등록되지 않는다.</p>
 */
@Slf4j
...
public class MessageStructureExecutor implements ManagementExecutor {
    ...
    public boolean supports(String gubun) {
        return GUBUN.equals(gubun) && messageStructurePool != null;
    }
