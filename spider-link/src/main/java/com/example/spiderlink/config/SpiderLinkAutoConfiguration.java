 ...
 * {@code WebMvcConfig})은 {@link SpiderLinkServletAutoConfiguration}에서 별도 관리된다.
 * spring-webmvc가 없는 TCP 전용 WAS에서 이 클래스 introspect 시 발생하는
 * {@code NoClassDefFoundError}를 방지하기 위해 분리되었다.</p>
 *
 */
