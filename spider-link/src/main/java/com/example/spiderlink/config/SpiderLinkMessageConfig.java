 ...
 * {@link MessageStructurePool}이 의존하는 {@code MessageMetaMapper}를 스캔하고,
 * {@link MessageStructurePool} / {@link FixedLengthParser} 빈을 컨텍스트에 등록한다.</p>
 *
...
@Import({MessageStructurePool.class, FixedLengthParser.class})
