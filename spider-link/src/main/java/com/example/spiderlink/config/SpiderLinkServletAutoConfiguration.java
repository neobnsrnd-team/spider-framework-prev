 ...
 * TCP 전용 WAS(mock-core 등)에서 {@link SpiderLinkAutoConfiguration} introspect 시
 * {@code NoClassDefFoundError}가 발생하는 문제를 방지한다.</p>
 *
...
public class SpiderLinkServletAutoConfiguration {
     ...
     * TCP의 {@link com.example.spiderlink.domain.management.ManagementReloadCommandHandler}와
