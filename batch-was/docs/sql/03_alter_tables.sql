...
-- ============================================================
-- ============================================================
-- #61: FWK_BATCH_APP SLA_SECONDS 컬럼 추가
-- 배치별 최대 허용 실행 시간(초)을 관리한다. NULL이면 SLA 미적용.
-- 개발자가 직접 DB에서 실행해야 함
-- ============================================================
ALTER TABLE FWK_BATCH_APP ADD (
    SLA_SECONDS NUMBER(10) DEFAULT NULL
);
COMMENT ON COLUMN FWK_BATCH_APP.SLA_SECONDS IS '최대 허용 실행 시간(초), NULL이면 SLA 미적용';
