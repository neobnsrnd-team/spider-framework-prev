...
class TrxControllerTest {
    ...
    private com.example.spideradmin.domain.transaction.dto.TrxCreateResponse buildCreateResponse(String trxId) {
        return com.example.spideradmin.domain.transaction.dto.TrxCreateResponse.builder()
                .trxId(trxId)
                .trxName("E2E 거래명")
                .trxType("A")
                .retryTrxYn("N")
