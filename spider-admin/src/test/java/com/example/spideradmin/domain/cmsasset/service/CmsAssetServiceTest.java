...
class CmsAssetServiceTest {
    ...
    @Mock
    private com.example.spideradmin.domain.cmsasset.client.CmsBuilderClient cmsBuilderClient;

    @Mock
    private com.example.spideradmin.domain.cmsasset.validator.AssetUploadValidator assetUploadValidator;
