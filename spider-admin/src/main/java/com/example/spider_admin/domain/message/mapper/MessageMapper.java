package com.example.spider_admin.domain.message.mapper;
...
public interface MessageMapper {
     ...
     */
    List<com.example.spider_admin.domain.message.dto.FieldPoolVerifyResponse> verifyFieldPool(
            @Param("fieldIds") List<String> fieldIds);

    /**
     * Oracle 시스템 뷰에서 테이블 컬럼 정보를 조회합니다.
     */
    List<com.example.spider_admin.domain.message.dto.TableColumnResponse> findTableColumns(
